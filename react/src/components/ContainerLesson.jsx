...
export function ContainerLesson({ title, children }) {

  // ContainerLesson 'comprimibile': il contenitore può mostrare o nascondere il suo contenuto, a seconda del valore di una variabile di stato
